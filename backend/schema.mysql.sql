...
CREATE TABLE IF NOT EXISTS registrations (
  ...
  age                  VARCHAR(96)  DEFAULT NULL,
  segment              VARCHAR(96)  DEFAULT NULL,
  drives               VARCHAR(96)  DEFAULT NULL,
  intent               VARCHAR(96)  DEFAULT NULL,
  budget               VARCHAR(96)  DEFAULT NULL,
  model_interest       VARCHAR(96)  DEFAULT NULL,
  ev_experience        VARCHAR(96)  DEFAULT NULL,
