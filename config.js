...
window.XPENG_CONFIG = {
  ...
  artist: {
    ...
    blockCopy: "Two of the country's biggest OPM stars: one for the XPENG X9 and L03 reveals, one closing the night with a full concert set.",
    lineupCopy: "Two of the country's biggest OPM stars take the stage, turning up the energy for the XPENG X9 and L03 reveal before capping off Driving Into A New Day with a full concert set. Find out who's hitting the stage one week before the event.",
    acts: [
